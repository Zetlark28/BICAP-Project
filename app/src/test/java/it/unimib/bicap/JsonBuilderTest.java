...
public class JsonBuilderTest {
    ...
    public void creaPasso_Ok() throws JSONException {
        JSONObject result = jsonBuilder.creaPasso("questionario","linkquestionario");
    ...
    public void creaProgetto_Ok() throws JSONException {
        JSONObject result = jsonBuilder.creaProgetto("nome1","descrizione1","autore1");
    ...
    public void aggiungiPassoAllaLista_Ok() throws JSONException {
        JSONObject passo1 = jsonBuilder.creaPasso("questionario","link questionario1");
        JSONObject passo2 = jsonBuilder.creaPasso("pdf","link pdf");
